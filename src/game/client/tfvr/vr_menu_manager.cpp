...
ConVar tfvr_cursor_vr_sensitivity("tfvr_cursor_vr_sensitivity", "50", FCVAR_ARCHIVE, "Scaling factor to compare VR movement to mouse (higher = VR needs less movement to win)");
