...
ConVar tfvr_killfeed_distance("tfvr_killfeed_distance", "80", FCVAR_ARCHIVE,
...
ConVar tfvr_killfeed_offset_x("tfvr_killfeed_offset_x", "-0.8", FCVAR_ARCHIVE,
    "Horizontal offset (-1 to 1, positive = right)");
ConVar tfvr_killfeed_offset_y("tfvr_killfeed_offset_y", "1.3", FCVAR_ARCHIVE,
    "Vertical offset (-1 to 1, positive = up)");

ConVar tfvr_killfeed_follow_speed("tfvr_killfeed_follow_speed", "4", FCVAR_ARCHIVE,
    "How fast the kill feed follows head rotation (higher = faster, 0 = instant)");
ConVar tfvr_killfeed_deadzone("tfvr_killfeed_deadzone", "10", FCVAR_ARCHIVE,
