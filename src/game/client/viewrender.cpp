...
ConVar tfvr_comfort_vignette_strength( "tfvr_comfort_vignette_strength", "1.010000", FCVAR_ARCHIVE, "VR comfort vignette strength while moving (0.0-2.0)" );
...
//-----------------------------------------------------------------------------
// Purpose: TFVR: This copies the left or right eye image to the mono image so as to not render a 3rd time
// Input  : &view -
//			eye -
//-----------------------------------------------------------------------------
...
//
//-----------------------------------------------------------------------------
ConVar tfvr_hud_on_mirror("tfvr_hud_on_mirror", "0", FCVAR_ARCHIVE, "If enabled, displays the HUD on the desktop mirror window.");
